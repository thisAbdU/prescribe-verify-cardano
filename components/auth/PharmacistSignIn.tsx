...
export default function PharmacistSignIn() {
  ...
  // Mock user database
  const mockUsers = [
    { email: 'pharmacist@example.com', password: 'SecurePass123!', name: 'Dr. Jane Smith', pharmacy: 'City Pharmacy' },
    { email: 'pharmacy@meditrust.com', password: 'TestPass456!', name: 'Dr. John Doe', pharmacy: 'MediTrust Pharmacy' }
  ]
  ...
  return (
    <div className="max-w-md mx-auto mt-8 p-6 bg-white rounded-lg shadow-[0px_0px_0px_0.75px_#E0DEDB_inset] border border-[#E0DEDB]">
      <div className="text-center mb-6">
        <h2 className="text-2xl font-bold text-[#37322F] mb-2">Pharmacist Sign In</h2>
        <p className="text-[#605A57]">Access your pharmacy dashboard to verify prescriptions</p>
      </div>
      ...
      <div className="mt-6 text-center">
        <p className="text-sm text-[#605A57]">
          ...
          <button
            onClick={() => router.push('/pharmacy/signup')}
      ...
      <div className="mt-6 p-4 bg-[#F7F5F3] rounded-md border border-[#E0DEDB]">
        ...
        <div className="text-xs text-[#605A57] space-y-1">
          ...
          <p className="text-[#605A57] mt-2">Or try: pharmacy@meditrust.com / TestPass456!</p>
        </div>
      </div>
    </div>
  )
